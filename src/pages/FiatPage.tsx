      ...
      <div className='fiat-metrics'>
        <div className='metric-card card'>
          ...
          <div className='metric-change positive'>
            <i className='fas fa-arrow-up' /> +12.5% vs last month
          </div>
        </div>
        <div className='metric-card card'>
          ...
          <div className='metric-change positive'>
            <i className='fas fa-arrow-up' /> +5.2% vs last month
          </div>
        </div>
        <div className='metric-card card'>
          ...
          <div className='metric-change positive'>
            <i className='fas fa-arrow-up' /> +3.1% vs last month
          </div>
        </div>
      </div>

      <TransactionFeed transactions={fiatTransactions} filter='ZAR' onFilterChange={() => {}} />
    </>
  );
};
